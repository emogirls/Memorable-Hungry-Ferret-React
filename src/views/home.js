...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Memorable Hungry Ferret</title>
        <meta property="og:title" content="Memorable Hungry Ferret" />
      </Helmet>
      <div className="home-header">
        ...
        >
          <span className="logo">HIDDENEYE</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Unleash the Power of HiddenEye
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Your Ultimate OSINT Tool Subscription</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Powerful Features of HiddenEye
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Unleash the potential of oSINT with these advanced
                      capabilities
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                heading="Phishing Campaigns"
                subHeading="Easily create and launch phishing campaigns to test security awareness"
              ></FeatureCard>
              <FeatureCard
                heading="Credential Harvesting"
                subHeading="Efficiently collect login credentials through various methods"
              ></FeatureCard>
              <FeatureCard
                heading="Social Engineering Attacks"
                subHeading="Craft and execute social engineering attacks to gather information"
              ></FeatureCard>
              <FeatureCard
                heading="Customizable Templates"
                subHeading="Use pre-built templates or create your own for personalized attacks"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock the full potential of HiddenEye with our flexible
                  pricing options
                </span>
              </span>
            </span>
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">
                    Limited access to oSINT capabilities
                  </span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container12">
                ...
                <div className="home-container14">
                  ...
                  <span className="bodySmall">
                    Full access to oSINT capabilities
                  </span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container20">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">Enhanced security features</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  HiddenEye offers a comprehensive suite of tools to gather and
                  analyze information from various sources, empowering you with
                  valuable insights for your investigations. With features like
                  phishing attacks, social engineering, and more, HiddenEye is
                  your go-to tool for OSINT.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container27">
              <Question1
                answer="HiddenEye is a tool subscription service with oSINT capabilities."
                question="What is HiddenEye?"
              ></Question1>
              <Question1
                answer="You can subscribe to HiddenEye by registering on our website and choosing a pricing plan."
                question="How can I subscribe to HiddenEye?"
              ></Question1>
              <Question1
                answer="We accept payments through PayPal for your convenience."
              ...
              ></Question1>
              <Question1
                answer="Yes, we take data security seriously and ensure that your information is protected."
                question="Is my information secure with HiddenEye?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container28">
            ...
            <nav className="home-nav1">
              ...
              <span className="home-nav422 bodySmall">Register</span>
